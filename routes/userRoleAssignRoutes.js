// //routes/userRoleAssignRoutes.js

// const express = require('express');
// const router = express.Router();
// const userRoleAssignController = require('../controllers/userRoleAssignController');

// router.get('/UserRole', userRoleAssignController.renderInsertForm);
// router.post('/assignUserRole', userRoleAssignController.insertUserRole);
